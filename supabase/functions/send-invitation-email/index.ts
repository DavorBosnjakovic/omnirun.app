...
<body style="margin:0; padding:0; background:#1a1a1a; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#1a1a1a; padding:40px 20px;">
    <tr>
      <td align="center">
        <table width="520" cellpadding="0" cellspacing="0" style="background:#2f3238; border-radius:12px; overflow:hidden;">
            ...
            <td style="padding:24px 32px 32px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td>
                    <a href="${DOWNLOAD_URL}"
                       style="display:block; background:#3b3f47; color:#ffffff; text-align:center;
          ...
          <!-- Footer -->
          <tr>
            <td style="padding:16px 32px; border-top:1px solid #3b3f47; text-align:center;">
              <p style="margin:0; font-size:11px; color:#6b7280;">
                Omnirun — AI-powered app builder
              </p>
            </td>
          </tr>
